...
import { logo } from "../../../utils/getAssets";
  ...
  return (
    <header className="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full text-sm p-6 absolute left-0 right-0 top-0 font-satoshi font-medium">
      ...
      >
        ...
        >
          <div className="flex flex-col gap-20 bg-white-08 border border-white-08 max-w-max ml-auto py-4 px-6 rounded-full mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0">
