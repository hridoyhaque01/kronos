...
function GetKronos({ width }) {
  return (
    <section className="px-4 mt-8 sm:mt-16 lg:mt-36">
      <div className={width}>
        <div className="">
          <div className="flex flex-col items-start sm:flex-row gap-7 justify-between bg-blackReg rounded-[18px] sm:items-center p-6 md:p-10 lg:p-16 gradient-border font-openSans">
