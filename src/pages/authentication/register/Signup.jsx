      ...
      <div className="w-full max-w-[424px] mx-auto px-6">
            ...
            <div className="flex flex-col gap-2 ">
              ...
              <div className="relative">
                <input
                  ...
                  className="p-3 placeholer:text-fadeMid text-sm w-full border border-white rounded-md flex items-center gap-5 bg-transparent outline-none"
                />
              </div>
            </div>
        ...
        <div className="mt-6 md:mt-12">
          ...
          <p className="text-center text-sm font-semibold mt-6 md:mt-12">
            ...
            <Link to="/signin" className="text-orangeDark">
              Sign In
            </Link>
          </p>
        </div>
